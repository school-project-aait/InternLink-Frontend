...
@Composable
fun StudentStatusReminderScreen(viewModel: StudentStatusViewModel= viewModel(),
...
@Composable
fun PreviewStudentStatusReminderScreen() {
    StudentStatusReminderScreen(
        viewModel = StudentStatusViewModel(PreviewStudentStatusRepository())
    )
}
